...
$( document ).ready(function() {
  $('#button').on("click", function(){
    ...
    if (answer === "1" || answer === "Go to the bike store"){
      ...
      // if (answer === "1" || answer === "The stylish road bike") {
      //   score += 1;
    ...
    } else if (answer === "2" || answer === "Go to the Grammys") {
        score += 1;
        content = "<p>'My greatest pain in life is that I will never be able to see myself perform live. But everyone else will. Let's bounce,' says Kanye. You take Kanye's chopper to the Grammys and land on the red carpet. As you make your way to your seats, Kanye sees that Drake has taken his seat. 'I'm about to throw some kazoo on this bitch! You got my back?' Do you <br/>1. Have his back <br/>2. Turn traitor and support Drake <br/>3. Find T-Swift and see if she's dating anyone right now</p>";
        displayText(content);
    ...
    } else if (answer === "3" || answer === "Go get some food") {
      score += 1;
      content = "<p>'I am going to order the salmon medium instead of medium well. I don't want to ruin the magic,' says Kanye. You jump on the back of his crotch rocket and ride down to Fish and Shizz. You are seated in the VIP section and given a menu. What do you order? </br>1. The salmon </br>2. The filet mignon </br>3. Doritos and dom perignon</p>";
  ...
  function displayText(content) {
   ...
   function kanyePout() {
     displayText("Your unwillingness to play by Kanye's rules has angered Kanye. He takes his ball and goes home. You lose.");
   };
